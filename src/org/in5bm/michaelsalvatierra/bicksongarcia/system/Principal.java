...
//        cargadorFXML.setLocation(Principal.class.getResource(PAQUETE_VIEWS + vistaFXML));  
//        InputStream archivo = Principal.class.getResourceAsStream(PAQUETE_VIEWS + vistaFXML);
